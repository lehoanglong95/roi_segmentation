...
if __name__ == '__main__':
    gt = np.load("/home/longlh/hard_2/PycharmProjects/roi_segmentation/result_relabel/BP907 20181119/gt.npy")[0]
    predict = np.load("/home/longlh/hard_2/PycharmProjects/roi_segmentation/result_relabel/BP907 20181119/predict.npy")[0]
    for i in range(gt.shape[0]):
        slice_gt = gt[i]
        slice_predict = predict[i]
        if 1 in np.unique(slice_gt):
            pairing, _, _ = pair_coordinates(slice_gt, slice_predict, 5)
            print(pairing.shape)